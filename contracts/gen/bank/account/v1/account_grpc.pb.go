...
const (
	...
	AccountService_ListAccounts_FullMethodName = "/bank.account.v1.AccountService/ListAccounts"
	AccountService_BlockAccount_FullMethodName = "/bank.account.v1.AccountService/BlockAccount"
	AccountService_CloseAccount_FullMethodName = "/bank.account.v1.AccountService/CloseAccount"
	AccountService_GetBalance_FullMethodName   = "/bank.account.v1.AccountService/GetBalance"
)
...
type AccountServiceClient interface {
	...
	BlockAccount(ctx context.Context, in *BlockAccountRequest, opts ...grpc.CallOption) (*Account, error)
...
func (c *accountServiceClient) OpenAccount(ctx context.Context, in *OpenAccountRequest, opts ...grpc.CallOption) (*Account, error) {
...
func (c *accountServiceClient) BlockAccount(ctx context.Context, in *BlockAccountRequest, opts ...grpc.CallOption) (*Account, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Account)
...
func (c *accountServiceClient) CloseAccount(ctx context.Context, in *CloseAccountRequest, opts ...grpc.CallOption) (*Account, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Account)
...
type AccountServiceServer interface {
	...
	BlockAccount(context.Context, *BlockAccountRequest) (*Account, error)
...
func (UnimplementedAccountServiceServer) OpenAccount(context.Context, *OpenAccountRequest) (*Account, error) {
...
func (UnimplementedAccountServiceServer) BlockAccount(context.Context, *BlockAccountRequest) (*Account, error) {
	return nil, status.Error(codes.Unimplemented, "method BlockAccount not implemented")
}
func (UnimplementedAccountServiceServer) CloseAccount(context.Context, *CloseAccountRequest) (*Account, error) {
